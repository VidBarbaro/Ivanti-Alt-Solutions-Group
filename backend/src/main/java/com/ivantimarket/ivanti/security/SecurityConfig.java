...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/api/login/**","/api/register/**", "/api/token/refresh/**", "/api/users/**", "/api/packages/get/**", "/api/packages/","/api/packages/download**","/user/login/**", "/api/packages/create",
                ...
                "/api/packages/favourites/add", "/api/packages/favourites/check", "/api/packages/favourites/remove", "/api/review/create", "/api/user/changeFirstTimeVar", "/api/packages/first3packages").permitAll();
